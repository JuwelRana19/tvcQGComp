---
title: "Get started with tvcQGComp"
author: "Juwel Rana"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Get started with tvcQGComp}
...
The package includes the complete simulated dataset used in this example.
...
interventions. In this simple example, `age` and `income_inadequacy` are used
as baseline/time-fixed adjustment variables, while the seven neighborhood and
urban-form covariates are simulated forward as active time-varying covariates.
...
Use the bootstrap for confidence intervals and inspect diagnostics before
reporting results. See the
[bootstrap and diagnostics](bootstrap-and-diagnostics.html) guide.
