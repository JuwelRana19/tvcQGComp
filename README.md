...
[![GitHub release](https://img.shields.io/github/v/release/JuwelRana19/tvcQGComp?include_prereleases)](https://github.com/JuwelRana19/tvcQGComp/releases)
[![GitHub downloads](https://img.shields.io/github/downloads/JuwelRana19/tvcQGComp/total.svg)](https://github.com/JuwelRana19/tvcQGComp/releases)
...
`tvcQGComp` provides time-varying quantile g-computation workflows, including:
...
- `validate_tvcqgcomp_data()`
- `generate_intervention_scenarios()`
- `make_q_scenarios()`
- `tvcQGComp_survival()`
- `tvcQGComp_survival_boot()`
- `summarize_tvcqgcomp_bootstrap()`
- `as_risk_curve_df()`
- `plot_cumulative_risk_trajectory()` for the primary cumulative-incidence plot
- `plot_survival_trajectory()` for an optional survival plot
- `diagnose_tvcqgcomp_run()`
- `diagnose_tvcqgcomp_drift()`
